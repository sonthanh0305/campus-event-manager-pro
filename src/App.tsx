            ...
            <BrowserRouter>
              <PageTransition>
                <Routes>
                  ...
                  <Route path="/dashboard/events" element={<ProtectedRoute><EventsDashboard /></ProtectedRoute>} />
                  <Route path="/dashboard/clubs" element={<ProtectedRoute><ClubsDashboard /></ProtectedRoute>} />
                  <Route path="/dashboard/union" element={<ProtectedRoute><UnionDashboard /></ProtectedRoute>} />
                  <Route path="/dashboard/facilities" element={<ProtectedRoute><FacilitiesDashboard /></ProtectedRoute>} />
